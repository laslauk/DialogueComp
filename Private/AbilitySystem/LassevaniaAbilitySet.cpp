...
void FLassevaniaAbilityySet_GrantedHandles::AddAbilitySpecHandle(const FGameplayAbilitySpecHandle& Handle)
{
	if (Handle.IsValid())
	{
...
void FLassevaniaAbilityySet_GrantedHandles::AddGameplayEffectHandle(const FActiveGameplayEffectHandle& Handle)
{
	if (Handle.IsValid())
	{
...
void FLassevaniaAbilityySet_GrantedHandles::AddAttributeSet(UAttributeSet* Set)
{
	GrantedAttributeSets.Add(Set);

}

void FLassevaniaAbilityySet_GrantedHandles::TakeFromAbilitySystem(ULVAbilitySystemComponent* LVASC)
{
...
void ULassevaniaAbilitySet::GiveToAbilitySystem(ULVAbilitySystemComponent* LVASC, FLassevaniaAbilityySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject) const
{
