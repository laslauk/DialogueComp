...
USTRUCT(BlueprintType)
struct FLassevaniaAbilityySet_GrantedHandles
{
	GENERATED_BODY()
...
// The returned handles can be used later to take away anything that was granted.
	void GiveToAbilitySystem(ULVAbilitySystemComponent* LVASC, FLassevaniaAbilityySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
